    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                // validate
                if (_b.sent()) {
                    return [2 /*return*/, 'Username/Email: ' + email + ' is already taken'];
                }
                if (!(email && password)) return [3 /*break*/, 3];
                return [4 /*yield*/, userRepo.createUser(email, password, firstName, lastName, license)];
            case 2:
                _a = _b.sent();
                return [3 /*break*/, 4];
            case 3:
                _a = 'email and password cannot be empty';
                _b.label = 4;
            case 4:
                newUser = _a;
