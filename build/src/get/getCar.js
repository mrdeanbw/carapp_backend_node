    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, carRepo.findByUserId(userId)];
            case 1:
                foundCar = _a.sent();
                carMessage = 'Your car is a ' + foundCar.year + ' ' + foundCar.make + ' ' + foundCar.model + '. It has ' + foundCar.seats + ' seats and it is ' + (foundCar.lease === false ? 'not' : '') + ' a lease. The trim is: ' + foundCar.trim + ' and the specs are: ' + foundCar.specs;
                console.log('from getCar.ts ' + carMessage);
                return [2 /*return*/, carMessage];
        }
    });
}); };
