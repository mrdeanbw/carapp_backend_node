...
describe('find new car in database table', function () {
    var connection;
    var carRepo;
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    // Insert the record
                    return [4 /*yield*/, carRepo.createCar(false, 4, 2000, 'Geo', 'Metro', '?', '?', null)];
                case 2:
                    // Insert the record
                    _a.sent();
                    return [2 /*return*/];
    ...
    afterAll(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: 
                // Delete the record
                return [4 /*yield*/, carRepo.deleteCar('Geo', 'Metro')];
                case 1:
                    // Delete the record
                    _a.sent();
    ...
    test('Find new car that was inserted via make and model', function (done) { return __awaiter(void 0, void 0, void 0, function () {
        var foundCar;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, carRepo.findByMakeModel('Geo', 'Metro')];
                case 1:
                    foundCar = _a.sent();
...
//# sourceMappingURL=foundCar.test.js.map